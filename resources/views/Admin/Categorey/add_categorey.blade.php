...
<div class="row-fluid sortable">		
	<div class="box span12">
		<div class="box-header" data-original-title>
			<h2><i class="halflings-icon user"></i><span class="break"></span>Add Categorey</h2>
		</div>
		<div class="box-content">



		<form action="{{URL::to('/admin-save-categorey')}}" method="post" enctype="multipart/form-data">
			@csrf
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="file" class="input-xlarge" name="thumbnail" required>
				</div>
			</div>
